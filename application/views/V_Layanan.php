						...
						<section class="panel" style="margin-top:-490px;">
							<header class="panel-heading">
								<div class="panel-actions">
									<a  href="<?php echo base_url().'Layanan/tampilanTambahData' ?>">
								...
								<h2 class="panel-title">Data Layanan</h2>
							</header>
