						...
						<section class="panel" style="margin-top:-490px;">
							<header class="panel-heading">
								<div class="panel-actions">
									<a  href="<?php echo base_url().'Pekerja/tampilanTambahData' ?>">
								...
								<h2 class="panel-title">Data Pekerja</h2>
							</header>
							<form method="POST">
							<div class="panel-body">
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										<?php
											foreach($pekerja as $list){
										?>

										<tr>
											<td>
												<a href="<?php echo base_url().'Pekerja/tampilanDetailData/'.$list->id_pengguna;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-info">
													<i class="fa fa-plus"></i>Detail</button>
												</a>
												<a href="<?php echo base_url().'Pekerja/tampilanEditData/'.$list->id_pengguna;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-warning">
													<i class="fa fa-pencil"></i>Edit</button>
												</a>
												<a href="<?php echo base_url().'Pekerja/deleteData/'.$list->id_pekerja;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-danger">
													<i class="fa fa-trash-o"></i>Delete</button>
												</a>
											</td>
											<td><?php echo $list->id_pekerja; ?></td>
