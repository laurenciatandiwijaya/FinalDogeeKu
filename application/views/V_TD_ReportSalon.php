					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>ReportSalon</span></li>
								<li><span>Tambah Data Report Salon</span></li>
							</ol>
						</div>
					</header>
						...
						<form id="summary-form" action="<?php echo base_url(). 'ReportSalon/tambahData'?>" method="POST" class="form-horizontal">
							<section class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">Tambah Data Report Salon</h2>
								</header>
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Layanan Salon 1<span class="required">*</span></label>
										<div class="col-md-6">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Layanan Salon 2</label>
										<div class="col-md-6">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Layanan Salon 3</label>
										<div class="col-md-6">
											<select name="id_detail_layanan[]" data-plugin-selectTwo class="form-control populate">
												<option disabled value="" Selected>Pilih Layanan</option>
												<?php foreach($detailLayanan as $list){ ?>
