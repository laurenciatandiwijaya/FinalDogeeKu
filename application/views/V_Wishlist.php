						...
						<section class="panel" style="margin-top:-490px;">
							<header class="panel-heading">
								<div class="panel-actions">
									<a  href="<?php echo base_url().'Wishlist/tampilanTambahData' ?>">
										<button type="Submit" class="mb-xs mt-xs mr-xs btn btn-primary">
											Tambah Data Wishlist
										</button>
									</a>
								</div>
						
								<h2 class="panel-title">Data Wishlist</h2>
							</header>
							<div class="panel-body">
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										<tr>
											<td>
												<a href="<?php echo base_url().'Wishlist/tampilanDetailData/'.$list->id_wishlist;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-info">
													<i class="fa fa-plus"></i>Detail</button>
												</a>
												<a href="<?php echo base_url().'Wishlist/tampilanEditData/'.$list->id_wishlist;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-warning">
													<i class="fa fa-pencil"></i>Edit</button>
												</a>
												<a href="<?php echo base_url().'Wishlist/deleteData/'.$list->id_wishlist;?> ">
