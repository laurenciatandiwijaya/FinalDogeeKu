			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div style="margin-top:-490px;">
						<form id="summary-form" action="<?php echo base_url(). 'JenisAnjing/index'?>" method="POST" class="form-horizontal">
							<section class="panel">
								...
								?>
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" name="id_jenis_anjing" value="<?php echo $list->id_jenis_anjing; ?>" class="form-control" readonly/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">Nama Jenis Anjing</label>
										<div class="col-sm-6">
											<input type="text" name="nama_jenis_anjing" value="<?php echo $list->nama_jenis_anjing; ?>" class="form-control"  readonly/>
										</div>
									</div>
									<div class="form-group">
