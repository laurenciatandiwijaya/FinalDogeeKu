						...
						<section class="panel" style="margin-top:-490px;">
							<header class="panel-heading">
								<div class="panel-actions">
									<a  href="<?php echo base_url().'Anjing/tampilanTambahData' ?>">
								...
								<h2 class="panel-title">Data Anjing</h2>
							</header>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									<thead>
										<tr>
											...
											<th width="10%">ID Anjing</th>	
											<th width="20%">Nama Anjing</th>
											<th width="20%">Nama Pemilik</th>
											<th width="15%">Jenis Anjing</th>
											<th width="10%">Jenis Kelamin</th>
											<th width="10%">Berat Badan (kg)</th>
