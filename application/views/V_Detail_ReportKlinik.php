					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Detail Data Report Klinik  .</span></li>
							</ol>
						</div>
					</header>

					<div style="margin-top:-490px;">
						<form id="summary-form" action="<?php echo base_url(). 'ReportKlinik/index'?>" method="POST" class="form-horizontal">
							<section class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">Detail Data Report Klinik</h2>
								</header>
								...
								?>
									<div class="form-group">
										<label class="col-sm-3 control-label">ID Report Klinik</label>
										<div class="col-sm-6">
											<input type="text" name="id_report_klinik" value="<?php echo $list->id_report_klinik; ?>" 
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" name="nama_pekerja" value="<?php echo $list->nama_pekerja; ?>" class="form-control"readonly/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">Status Report</label>
										<div class="col-sm-6">
											<input type="text" name="status_report" value="<?php echo $list->status_report; ?>" class="form-control"readonly/>
										</div>
									</div><br>
									...
									<?php foreach($obat as $listObat){ $i=1; ?>
									<div class="form-group">
										<label class="col-sm-3 control-label">Obat <?php echo $i; ?></label>
										<div class="col-sm-6">
											<input type="text" name="id_barang" value="<?php echo $listObat->nama_barang 
											." / ".$listObat->ukuran ." ".$list->satuan; ?>" 
											class="form-control"readonly/>
										</div>
										<label class="col-sm-1 control-label">Jumlah</label>
										<div class="col-sm-2">
											<input type="text" name="jumlah_barang" value="<?php echo $listObat->jumlah_barang; ?>" readonly>
										</div>
									</div>
									<?php
									$i++;
