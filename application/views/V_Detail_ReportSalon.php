					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Report Salon</span></li>
								<li><span>Detail Data Report Salon  .</span></li>
							</ol>
						</div>
					</header>

					<div style="margin-top:-490px;">
						<form id="summary-form" action="<?php echo base_url(). 'ReportSalon/index'?>" method="POST" class="form-horizontal">
							<section class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">Detail Data Report Salon</h2>
								</header>
								...
								?>
									<div class="form-group">
										<label class="col-sm-3 control-label">ID Report Salon</label>
										<div class="col-sm-6">
											<input type="text" name="id_report_salon" value="<?php echo $list->id_report_salon; ?>" 
