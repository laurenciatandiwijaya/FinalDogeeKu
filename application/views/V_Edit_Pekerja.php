					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Edit Data Pekerja  .</span></li>
							</ol>
						</div>
					</header>

					<div style="margin-top:-490px;">
						<form id="summary-form" action="<?php echo base_url(). 'Pekerja/editData'?>" method="POST" class="form-horizontal">
							<section class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">Edit Data Pekerja</h2>
								</header>
								...
								?>
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" name="id_pekerja" value="<?php echo $listPekerja->id_pekerja; ?>" 
									...
									?>
									<div class="form-group">
										<label class="col-sm-3 control-label">Nama Pekerja<span class="required">*</span></label>
										<div class="col-sm-6">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select name="id_jabatan" data-plugin-selectTwo class="form-control populate">
												<?php foreach($jabatan as $listJabatan){ ?>

													<option value="<?php echo $listJabatan->id_jabatan; ?>" 
													<?php if($listJabatan->id_jabatan == $listPekerja->id_jabatan){ 
														echo "selected"; 
													} ?>>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input class="col-md-7" id="datepicker2" name="tanggal_masuk" type="date" 
											value="<?php echo $listPekerja->tanggal_masuk; ?>" required>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Tipe Pengguna<span class="required">*</span></label>
										<div class="col-md-6">
											<select name="id_tipe_pengguna" data-plugin-selectTwo class="form-control populate">
												<?php foreach($tipePengguna as $listTP){ ?>

													<option value="<?php echo $listTP->id_tipe_pengguna; ?>" 
													<?php if($listTP->id_tipe_pengguna == $listPengguna->id_tipe_pengguna){ 
														echo "selected"; 
													} ?>>
