					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Tambah Data Pelanggan  .</span></li>
							</ol>
						</div>
					</header>

					<div style="margin-top:-490px;">
							<form id="summary-form" action="<?php echo base_url(). 'Pelanggan/tambahData'?>" method="POST" class="form-horizontal">
								<section class="panel">
									<header class="panel-heading">
										<h2 class="panel-title"><h2>Tambah Data Pelanggan</h2>
									</header>
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-md-3 control-label">Tanggal Registrasi<span class="required">*</span></label>
											<div class="col-md-3">
												<input id="datepicker2" name="tanggal_registrasi" type="date" value="<?php date("Y-m-d"); ?>" required>
											</div>
										</div>
										<div class="form-group">
