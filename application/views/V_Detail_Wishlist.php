					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Detail Data Wishlist  .</span></li>
							</ol>
						</div>
					</header>

					<div style="margin-top:-490px;">
						<form id="summary-form" action="<?php echo base_url(). 'Wishlist/index'?>" method="POST" class="form-horizontal">
							<section class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">Detail Data Wishlist</h2>
								</header>
								...
								?>
									<div class="form-group">
										<label class="col-sm-3 control-label">ID Wishlist</label>
										<div class="col-sm-6">
											<input type="text" name="id_wishlist" value="<?php echo $list->id_wishlist; ?>" class="form-control" readonly/>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-6">
											...
											foreach($pelanggan as $listPelanggan){
												if($listPelanggan->id_pelanggan == $list->id_pelanggan){ ?>
													<input type="text" name="nama_lengkap" value="<?php echo $listPelanggan->nama_lengkap; ?>" 
