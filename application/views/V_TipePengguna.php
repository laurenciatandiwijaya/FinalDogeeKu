						...
						<section class="panel" style="margin-top:-490px;">
							<header class="panel-heading">
								<div class="panel-actions">
									<a  href="<?php echo base_url().'TipePengguna/tampilanTambahData' ?>">
								...
								<h2 class="panel-title">Data Tipe Pengguna</h2>
							</header>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									<thead>
										<tr>
											...
											<th width="20%">ID Tipe Pengguna</th>
											<th width="20%">Nama Tipe Pengguna</th>
									...
									<tbody>
										...
										<tr>
											<td>
												<a href="<?php echo base_url().'TipePengguna/tampilanDetailData/'.$list->id_tipe_pengguna;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-info">
													<i class="fa fa-plus"></i>Detail</button>
												</a>
												<a href="<?php echo base_url().'TipePengguna/tampilanEditData/'.$list->id_tipe_pengguna;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-warning">
													<i class="fa fa-pencil"></i>Edit</button>
												</a>
												<a href="<?php echo base_url().'TipePengguna/deleteData/'.$list->id_tipe_pengguna;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-danger">
													<i class="fa fa-trash-o"></i>Delete</button>
												</a>
											</td>
											<td><?php echo $list->id_tipe_pengguna; ?></td>
											<td><?php echo $list->nama_tipe_pengguna; ?></td>
