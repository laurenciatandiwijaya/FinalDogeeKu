					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Detail Data Tipe Pengguna  .</span></li>
							</ol>
						</div>
					</header>

					<div style="margin-top:-490px;">
						<form id="summary-form" action="<?php echo base_url(). 'TipePengguna/index'?>" method="POST" class="form-horizontal">
							<section class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">Detail Data Tipe Pengguna</h2>
								</header>
								...
								?>
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" name="id_tipe_pengguna" value="<?php echo $list->id_tipe_pengguna; ?>" class="form-control" readonly/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">Nama Tipe Pengguna</label>
										<div class="col-sm-6">
											<input type="text" name="nama_tipe_pengguna" value="<?php echo $list->nama_tipe_pengguna; ?>" class="form-control"readonly/>
										</div>
									</div>
									<div class="form-group">
