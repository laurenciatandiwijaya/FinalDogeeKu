    ...
    <body>
        ...
        <div class="main" id="main">
            ...
            <div class="register_kanan">
                ...
                <form method="POST" action="<?php echo base_url().'PPlanner/coba_tambahKegiatanAnjing'?>">
                    <p>Nama Anjing
                        <select name="nama_anjing">
                            <?php foreach($data_anjing as $list){?>
                                <option value="<?php echo $list->id_anjing;?>"><?php echo $list->nama_anjing; ?></option>
                            <?php } ?>
                        </select>
                    </p>
                    ...
                    <p>Start Date
                        <input id="datepicker" name="start_date" type="date" required>
                    </p>
                    <p>End Date
                        <input id="datepicker" name="end_date" type="date" required>
                    </p>
