					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Detail Data Jabatan  .</span></li>
							</ol>
						</div>
					</header>

					<div style="margin-top:-490px;">
							<form id="summary-form" action="<?php echo base_url(). 'Jabatan/index'?>" method="POST" class="form-horizontal">
								<section class="panel">
									<header class="panel-heading">
										<h2 class="panel-title">Detail Data Jabatan</h2>
									</header>
									...
									?>
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" name="id_jabatan" value="<?php echo $list->id_jabatan; ?>" class="form-control" readonly/>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Nama Jabatan</label>
											<div class="col-sm-6">
												<input type="text" name="nama_jabatan" value="<?php echo $list->nama_jabatan; ?>" class="form-control"readonly/>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Gaji</label>
											<div class="col-sm-6">
												<input type="text" name="gaji" value="<?php echo $list->gaji; ?>" class="form-control"readonly/>
											</div>
										</div>
										<div class="form-group">
