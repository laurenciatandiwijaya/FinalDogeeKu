			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div style="margin-top:-490px;">
							<form id="summary-form" action="<?php echo base_url(). 'KategoriBarang/index'?>" method="POST" class="form-horizontal">
								<section class="panel">
									...
									?>
										<div class="form-group">
											<label class="col-sm-3 control-label">ID Kategori Barang</label>
											<div class="col-sm-6">
												<input type="text" name="id_kategori_barang" value="<?php echo $list->id_kategori_barang; ?>" 
												class="form-control" readonly/>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Nama Kategori Barang</label>
											<div class="col-sm-6">
												<input type="text" name="nama_kategori_barang" value="<?php echo $list->nama_kategori_barang; ?>" 
												class="form-control"  readonly/>
											</div>
										</div>
										<div class="form-group">
