						...
						<section class="panel" style="margin-top:-490px;">
							<header class="panel-heading">
								<div class="panel-actions">
									<a  href="<?php echo base_url().'JenisAnjing/tampilanTambahData' ?>">
										<button type="Submit" class="mb-xs mt-xs mr-xs btn btn-primary">
											Tambah Data Jenis Anjing
										</button>
									</a>
								</div>
						
								<h2 class="panel-title">Data Jenis Anjing</h2>
							</header>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									<thead>
										<tr>
											...
											<th width="20%">ID Jenis Anjing</th>
											<th width="30%">Nama Jenis Anjing</th>
									...
									<tbody>
										...
										<tr>
											<td>
												<a href="<?php echo base_url().'JenisAnjing/tampilanDetailData/'.$list->id_jenis_anjing;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-info">
													<i class="fa fa-plus"></i>Detail</button>
												</a>
												<a href="<?php echo base_url().'JenisAnjing/tampilanEditData/'.$list->id_jenis_anjing;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-warning">
													<i class="fa fa-pencil"></i>Edit</button>
												</a>
												<a href="<?php echo base_url().'JenisAnjing/deleteData/'.$list->id_jenis_anjing;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-danger">
													<i class="fa fa-trash-o"></i>Delete</button>
												</a>
											</td>
											<td><?php echo $list->id_jenis_anjing; ?></td>
											<td><?php echo $list->nama_jenis_anjing; ?></td>
