					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Tambah Data Report Klinik</span></li>
							</ol>
						</div>
					</header>

					<div style="margin-top:-490px;">
						<form id="summary-form" action="<?php echo base_url(). 'ReportKlinik/tambahData'?>" method="POST" class="form-horizontal">
							<section class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">Tambah Data Report Klinik</h2>
								</header>
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Layanan Klinik 1<span class="required">*</span></label>
										<div class="col-md-6">
											<select required name="id_detail_layanan[]" data-plugin-selectTwo class="form-control populate">
												...
												<option value="">Unselect Layanan</option>
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Layanan Klinik 2</label>
										<div class="col-md-6">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Layanan Klinik 3</label>
										<div class="col-md-6">
											<select name="id_detail_layanan[]" data-plugin-selectTwo class="form-control populate">
												<option disabled value="" Selected>Pilih Layanan</option>
												<option value="">Unselect Layanan</option>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select name="id_barang[]" data-plugin-selectTwo class="form-control populate">
												...
												<?php foreach($obat as $list){ ?>
													<option value="<?php echo $list->id_barang; ?>">
														<?php echo $list->nama_barang ." / ".$list->ukuran ." "
														.$list->satuan ." / Stok: ".$list->jumlah_barang ;?>
													</option>
												<?php }?>
											</select>
										</div>
