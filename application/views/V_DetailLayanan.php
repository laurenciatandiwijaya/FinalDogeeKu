						...
						<section class="panel" style="margin-top:-490px;">
							<header class="panel-heading">
								<div class="panel-actions">
									<a  href="<?php echo base_url().'DetailLayanan/tampilanTambahData' ?>">
										<button type="Submit" class="mb-xs mt-xs mr-xs btn btn-primary">
											Tambah Data Detail Layanan
										</button>
									</a>
								</div>
						
								<h2 class="panel-title">Data Detail Layanan</h2>
							</header>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									<thead>
										<tr>
											...
											<th width="10%">ID Detail Layanan</th>
											<th width="10%">Nama Layanan</th>
											<th width="20%">Nama Detail Layanan</th>
											<th width="20%">Deskripsi Layanan</th>
									...
									<tbody>
										<?php
											foreach($detailLayanan as $list){
										?>

										<tr>
											<td>
												<a href="<?php echo base_url().'DetailLayanan/tampilanDetailData/'.$list->id_detail_layanan;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-info">
													<i class="fa fa-plus"></i>Detail</button>
												</a>
												<a href="<?php echo base_url().'DetailLayanan/tampilanEditData/'.$list->id_detail_layanan;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-warning">
													<i class="fa fa-pencil"></i>Edit</button>
												</a>
												<a href="<?php echo base_url().'DetailLayanan/deleteData/'.$list->id_detail_layanan;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-danger">
													<i class="fa fa-trash-o"></i>Delete</button>
												</a>
											</td>
											<td><?php echo $list->id_detail_layanan; ?></td>
											<td><?php echo $list->nama_layanan; ?></td>
											<td><?php echo $list->nama_detail_layanan; ?></td>
											<td><?php echo $list->deskripsi_layanan; ?></td>
