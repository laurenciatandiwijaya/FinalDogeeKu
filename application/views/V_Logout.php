...
<html>
    ...
    <body>
        <a href="<?php echo base_url()?>Login/account"><button class="logout_back">BACK</button></a>
        ...
        <div class="main" id="main">
            ...
            <div class="logout_kanan">
                <form method="POST" action="<?php echo base_url().'Login/coba_logout'?>">
                    <h1 class="tulisan_logout">LOGOUT</h1>
                    <h3><?php echo $this->session->userdata("email"); ?></h3>
                    <h3>Apakah anda yakin ingin log out sekarang?</h3>
                    <p><button class="logout_logout" type="submit">LOGOUT NOW</button></p>
                </form>
            </div>
        </div>
