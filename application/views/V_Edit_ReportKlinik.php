					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Edit Data Report Klinik  .</span></li>
							</ol>
						</div>
					</header>

					<div style="margin-top:-490px;">
						<form id="summary-form" action="<?php echo base_url(). 'ReportKlinik/editData'?>" method="POST" class="form-horizontal">
							<section class="panel">
							<header class="panel-heading">
									<h2 class="panel-title">Edit Data Report Klinik</h2>
								</header>
