						...
						<section class="panel" style="margin-top:-490px;">
							<header class="panel-heading">
								<div class="panel-actions">
									<a  href="<?php echo base_url().'ReportPenitipan/tampilanTambahData' ?>">
										<button type="Submit" class="mb-xs mt-xs mr-xs btn btn-primary">
											Tambah Report Penitipan
										</button>
									</a>
								</div>
						
								<h2 class="panel-title">Report Penitipan</h2>
							</header>
							<div class="panel-body">
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
										...
										<tr>
											<td>
												<a href="<?php echo base_url().'ReportPenitipan/tampilanDetailData/'.$list->id_report_penitipan;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-info">
													<i class="fa fa-plus"></i>Detail</button>
												</a>
												<a href="<?php echo base_url().'ReportPenitipan/tampilanEditData/'.$list->id_report_penitipan;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-warning">
													<i class="fa fa-pencil"></i>Edit</button>
												</a>
												<a href="<?php echo base_url().'ReportPenitipan/deleteData/'.$list->id_report_penitipan;?> ">
													<button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-danger">
													<i class="fa fa-trash-o"></i>Delete</button>
												</a>
											</td>
											<td><?php echo $list->id_report_penitipan; ?></td>
